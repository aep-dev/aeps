...
each other, clients to be built, and for developers to move between projects without needing to learn
...
AEP (API Enhancement Proposals) is an open-source, "anti-bike shedding" kit. It answers the routine
...
because we are introducing a stable version of the specification and establishing a release
cadence with [AEP-300](https://aep.dev/300/). This decouples stability for consumers and evolving our best practices:
